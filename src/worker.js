/**
 * Anger AI Game - Cloudflare Workers 后端
 * - 提供聊天 / 配置 / 记录 / 排行榜 / 后台管理 API
 * - 静态文件由 Cloudflare Pages / GitHub Pages 提供（这里只做 API）
 * - 记录存 KV: anger-ai-game-kv (id: ff1678a203a74fc0829d2c1df5de85a2)
 */
